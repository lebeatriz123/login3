...
?>
 ...
 <head>
  ...
  <title>Buscar Cadastro de Veículos</title>
...
<h1> BUSCAR CADASTRO DE VEÍCULOS</h1>
...
<input type="number" name="id" class="form-control" placeholder="Digite o ID do veículo que queira buscar">
